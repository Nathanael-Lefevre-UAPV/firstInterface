...
public class Test {
	...
	public static void test(int size, TextArea textArea){//, TextArea textArea){
		try {

			System.out.println();
			System.out.println("START TRAINING ...");
			System.out.println();
			textArea.setText("START TRAINING ...");
			//
			...
			double epochs = 1000000;//1000000000 ;

			System.out.println("---");
			textArea.setText("---");
			System.out.println("Load data ...");
			textArea.setText("Load data ...");
			...
			for(int i = 0; i < epochs; i++){
				...
				if ( i % 10000 == 0 ) {
					...
					textArea.setText(i*100/epochs + "% : Error at step "+i+" is "+ (error/(double)i));
			...
			if ( epochs > 0 ) {
				...
				textArea.setText("Error is " + error);
			}
			//
			...
			textArea.setText(inputs[0]+" or "+inputs[1]+" = "+Math.round(output[0])+" ("+output[0]+")");
		} 
		catch (Exception e) {
